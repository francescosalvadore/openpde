...
module openpde_integrator_adv_euler_explicit
    ...
    type, extends(integrator_adv) :: integrator_adv_euler_explicit
        !< Concrete class of integrator, Euler explicit scheme.
        contains
    ...
    endtype integrator_adv_euler_explicit
contains
    ! deferred public methods
    subroutine init(this, equ, description, filename, error)
        !< Initialize integrator.
        class(integrator_adv_euler_explicit), intent(inout)         :: this        !< The integrator.
...
end module openpde_integrator_adv_euler_explicit
