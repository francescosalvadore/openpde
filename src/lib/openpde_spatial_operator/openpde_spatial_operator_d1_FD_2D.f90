...
contains
    function operate(this, inp, dir) result(opr)
        ...
        opr_cur => associate_field_FD_2D(field_input=opr, emsg='calling procedure spatial_operator_d1_FD_2D%operate')
        inp_cur => associate_field_FD_2D(field_input=inp, emsg='calling procedure spatial_operator_d1_FD_2D%operate')
        mesh_cur => associate_mesh_FD_2D(mesh_input=inp%m, emsg='calling procedure spatial_operator_d1_FD_2D%operate')
