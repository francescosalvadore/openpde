...
module opendiff_spatial_operator_der1_fd_2d
    !< Concrete class of spatial operator for 1D derivative for Finite Difference 1D.
    ...
    type, extends(spatial_operator_der1) :: spatial_operator_der1_fd_2d
        !< Concrete class of spatial operator for first derivative for Finite Difference 1D.
        contains
            procedure :: operate !< Operator operation.
    endtype spatial_operator_der1_fd_2d
contains
    function operate(this, inp, dir) result(opr)
        !< Operator operation.
        class(spatial_operator_der1_fd_2d), intent(in)         :: this     !< The operator.
...
end module opendiff_spatial_operator_der1_fd_2d
