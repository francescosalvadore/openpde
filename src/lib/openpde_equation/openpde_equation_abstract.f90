!< Abstract (concrete with stopping methods) class of equation.
...
contains
    subroutine init(this, n_equ, field_mesh, inp, description, filename, error)
        ...
        error stop 'equation%init to be implemented by your equation and depending on your integrator'
    end subroutine init
    ...
    subroutine bc_e(this, inp, t)
        ...
        error stop 'equation%bc_e to be implemented by your equation and depending on your integrator'
    end subroutine bc_e
    ...
    subroutine bc_i(this, matA, vecB, t)
        ...
        real(R_P),       intent(in)            :: t    !< Time.
        error stop 'equation%bc_i to be implemented by your equation and depending on your integrator'
    end subroutine bc_i
    ...
    subroutine resid_e(this, inp, t)
        ...
        real(R_P),       intent(in)         :: t      !< Time.
        error stop 'equation%resid_e to be implemented by your equation and depending on your integrator'
    ...
    subroutine resid_emg(this, inp, t, output)
        ...
        real(R_P),       intent(in)          :: t         !< Time.
        error stop 'equation%resid_emg to be implemented by your equation and depending on your integrator'
    ...
    subroutine resid_i(this, inp, t)
        ...
        class(field),    intent(in), target :: inp(:) !< Input field.
        real(R_P),       intent(in)         :: t      !< Time.
        error stop 'equation%resid_i to be implemented by your equation and depending on your integrator'
    ...
    function jacobian(this, inp, t) result(opr)
        ...
        error stop 'equation%jacobian to be implemented by your equation and depending on your integrator'
